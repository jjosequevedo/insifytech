                ...
                <div className="items-center lg:flex">
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="lg:max-w-xl">
                            <h1 className="text-3xl font-semibold text-gray-800 dark:text-white lg:text-6xl">{t('Welcome to Insify Tech!')}</h1>
                            ...
                            <button className="px-5 py-2 mt-6 text-md tracking-wider text-white font-semibold transition-colors duration-300 transform bg-emerald-600 rounded-lg w-auto hover:bg-emerald-500 focus:outline-none focus:bg-emerald-500">{t("Let's talk")}</button>
                        </div>
                    </div>
